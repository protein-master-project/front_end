...
function createPolymerTraceMesh(ctx, unit, structure, theme, props, mesh) {
    ...
    while (polymerTraceIt.hasNext) {
        ...
        const isSheet = SecondaryStructureType.is(v.secStrucType, 4 /* SecondaryStructureType.Flag.Beta */);
        const isHelix = SecondaryStructureType.is(v.secStrucType, 2 /* SecondaryStructureType.Flag.Helix */);
